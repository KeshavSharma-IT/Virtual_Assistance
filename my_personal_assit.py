...
def wishme():
    ...
    if hour >= 0 and hour < 12:
        speak("Good Morning " + "keshav how may I help you..")
        print(("Good Morning " + "keshav  how may I help you.."))
    elif hour >= 12 and hour < 18:
        speak("Good Afternoon " + "keshav  how may I help you..")
        print("Good Afternoon " + "keshav  how may I help you..")
    else:
        speak("Good Evening " + "keshav  how may I help you..")
        print("Good Evening " + "keshav  how may I help you..")
...
def questions():
    ...
    if "what is your name" in command:
        ...
        no = {"kritika": '+919990847887',
                "dhirendra": '+919810673885', "My number": '+919643710652'}
        name = listenCommand()
